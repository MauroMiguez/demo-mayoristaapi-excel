...
function agregarProducto(el) {
  ...
  const producto = {
    producto: card.dataset.producto,                  // "art.3600"
    color: card.dataset.color,                        // "Celeste" (se actualiza con changeImg)
    imagen: card.querySelector(".main-img").src,      // "/images/pijama-3600/celeste.jpg"
    talle: card.querySelector(".size").value,         // ej. "talle 3"
