...
def generate_excel(order_id: int, order: Order):
    ...
    for item in order.items:
        ...
        print("Insertando imagen:", image_path)  # 👈 log para ver la ruta
...
Producto	Color	Talle	Cantidad	Imagen
art.600 - Corpiño doble tela	Negro	95	55	
art.1022 - Camiseta Morley	Negro	4	12	
art.3607	Gris	talle 3	1	
